    ...
    <section id="hero" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="#gallery" className="w-full sm:w-auto px-8 py-3 bg-gold-600 text-white rounded-sm hover:bg-gold-700 transition-colors">
            View Our Work
          </a>
          <a href="#contact" className="w-full sm:w-auto px-8 py-3 bg-transparent border border-white text-white rounded-sm hover:bg-white/10 transition-colors">
            Contact Us
          </a>
        </div>
      </div>
